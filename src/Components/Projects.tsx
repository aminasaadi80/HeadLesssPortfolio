...
function Projects() {
  ...
  const { loading: loadingPosts, error: postsError, data: postsData } = useQuery(
    currentLanguage === 'en' ? GET_POSTS_EN : GET_POSTS_FA
  );
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">
            {currentLanguage === 'en' ? pageData.enTitle || pageData.title : pageData.title}
          </h1>
          <p className="text-xl text-gray-600 dark:text-gray-300">
            {currentLanguage === 'en' ? pageData.enSubtitle || pageData.subtitle : pageData.subtitle}
          </p>
        </div>
        ...
        <div className="flex justify-center items-center space-x-2">
          ...
          >
            {currentLanguage === 'en' ? 'Previous' : 'قبلی'}
          </button>
